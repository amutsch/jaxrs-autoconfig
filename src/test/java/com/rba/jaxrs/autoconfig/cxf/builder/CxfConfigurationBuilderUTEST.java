...
public class CxfConfigurationBuilderUTEST {
    ...
    void emptyBuilder() {
        ...
        Assertions.assertAll(() -> Assertions.assertNull(config.getBus()),
            ...
            () -> Assertions.assertEquals(0, config.getIncomingInterceptors().size()),
            () -> Assertions.assertEquals(0, config.getOutgoingInterceptors().size()),
    ...
    void validateAddAndSetOnBuilder() {
        ...
        Assertions.assertAll(() -> Assertions.assertTrue(config.getBus() instanceof SpringBus),
            ...
            () -> Assertions.assertEquals(2, config.getIncomingInterceptors().size()),
            () -> Assertions.assertEquals(2, config.getOutgoingInterceptors().size()),
