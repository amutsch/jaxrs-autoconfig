 ...
 * if the context is enabled.  The context will be enabled if {@link ApiVersion} and all
 * {@link ApiContext} entries are enabled.  If any of the contexts are disabled the
