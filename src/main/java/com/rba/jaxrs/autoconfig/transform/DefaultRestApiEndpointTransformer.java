 ...
 * {@link com.rba.jaxrs.autoconfig.version.ApiVersion} and {@link com.rba.jaxrs.autoconfig.classify.ApiContext} interface.
 *
...
public class DefaultRestApiEndpointTransformer implements RestApiContextTransformer {
     ...
     */
    @Nullable
    private <T extends Enum<T> & ApiVersion> T resolveApiVersion(String apiVersion) {
        T versionEntry = null;
     ...
     */
    @Nullable
    private <T extends Enum<T> & ApiContext> T resolveApiContext(String apiContext) {
        T contextEntry = null;
